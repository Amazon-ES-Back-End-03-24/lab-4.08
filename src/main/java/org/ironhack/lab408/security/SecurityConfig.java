package org.ironhack.lab408.security;

import lombok.RequiredArgsConstructor;
import org.ironhack.lab408.security.filters.CustomAuthenticationFilter;
import org.ironhack.lab408.security.filters.CustomAuthorizationFilter;
...
public class SecurityConfig {
    ...
    protected SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((requests) -> requests
                .requestMatchers(HttpMethod.POST, "/blogposts").hasAnyAuthority("ROLE_ADMIN", "ROLE_CONTRIBUTOR")
                .requestMatchers(HttpMethod.POST, "/authors").hasAnyAuthority("ROLE_ADMIN")
                .requestMatchers(HttpMethod.PUT, "/blogposts/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_CONTRIBUTOR")
